...
def get_function(name = "constant", space=(-10.0, 10.0), d1=False, d2=False, d3=False, **kwargs):
    ...
    if name == "newton_raphson_example":
        ...
        def tangent_line(x, p_x, p_y):
            return slope(p_x) * (x - p_x) + p_y
...
def plt_function(name: Optional[str] = "constant", 
    ...
    available_functions = ["broken_rational", "broken", "br", "br",
                            ...
                            "linear", "li", "lin",
                            "logarithmic", "lo", "log",
                            "newton_raphson_example", "newton_raphson", "newton",
                            "normal_parabola", "np", "norm_par", "parab", "parabola",
                            "power", "p", "pow",
                            "quadratic", "q", "quad",
                            "trigonometric", "t", "tri", "trig"]

    available_3D_functions = ["multivariate1", "multi1", "multivariate2", "multi2", "multivariate3", 
                                "multi3", "multivariate4", "multi4", "multivariate5", "multi5"]
    ...
    if name in available_functions:
        ...
        # example function for newton raphson method
        elif name in ["newton_raphson_example", "newton_raphson", "newton"]:
            name = "newton_raphson_example"
            value_names = ["p_x"]
